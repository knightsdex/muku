  ...
  [332],
  {
    ...
    9685: (e, t, a) => {
      ...
      let s = (e) => {
        ...
        return (0, i.jsx)("div", {
          className:
            "flex flex-col items-center justify-center w-full max-w-full overflow-visible bg-pattern",
      ...
      var o = a(8847),
        ...
        m = a(1944);
      let x = {
        src: "/_next/static/media/tweet1.d35dd6d9.jpg",
        height: 631,
        width: 460,
        blurDataURL:
      ...
      let A = () => {
          ...
          return (
            ...
            (0, i.jsxs)("section", {
              className:
                "relative min-h-screen w-full overflow-visible z-10 pt-32",
              id: "home",
              style: {
                background:
                      ...
                      children: (0, i.jsx)(d.P.div, {
                        ...
                        children: (0, i.jsx)("div", {
                          ...
                          children: (0, i.jsx)(c.A, {
                            src: m.A,
                            alt: "MUKU - The Adorable Rice Companion",
                            layout: "responsive",
                        ...
                        (0, i.jsxs)("div", {
                          ...
                          children: [
                            ...
                            (0, i.jsxs)("div", {
                              ...
                              children: [
                                (0, i.jsx)(d.P.button, {
                                  ...
                                  whileTap: "tap",
                                  className:
                                    "px-6 py-4 rounded-lg text-white font-bold md:text-xl relative overflow-visible",
                                  onClick: t,
                                  style: {
                                    background:
                                      "linear-gradient(135deg, #FD8A1B, #FFD700)",
                                  ...
                                  children: (0, i.jsx)("span", {
                                    className:
                                      "z-30 relative flex items-center",
                                    children: "Buy Now",
                                  }),
                                }),
                                (0, i.jsx)(d.P.button, {
                            ...
                            (0, i.jsxs)(d.P.div, {
                              ...
                              className:
                                "bg-white bg-opacity-90 backdrop-blur-sm rounded-lg p-3 mb-6 border-2 border-orange-500 text-black/80 overflow-visible",
                              children: [
                                (0, i.jsx)("p", {
        ...
        f = () =>
          (0, i.jsxs)("section", {
            className: "relative py-16 md:py-24 overflow-visible z-10",
            id: "about",
            children: [
              (0, i.jsxs)("div", {
                className: "absolute inset-0 z-0",
                    ...
                    children: [
                              ...
                              children: [
                                (0, i.jsxs)("p", {
                                  children: [
                                    ...
                                    " — Kabosumama's adorable new cat - next in line to join the meme greats of her household!",
                                  ],
                                }),
                                (0, i.jsxs)("p", {
                                  children: [
                                    " We got the confirmation boys - Kabosukama just posted Muku playing with Cocoro",
                                    " ",
                                    // (0, i.jsx)("span", {
                                    //   className: "font-bold",
                                    //   style: { color: "#FD8A1B" },
                                ...
                                (0, i.jsxs)("p", {
                                  children: [
                                    "Currently watching this and I’m in talks with the person who made this screenshot. If he can get a second confirmation that Muku is indeed kabosumamas new cat, then this could be a good play.",
                                   
                                  ],
                                }),
                                (0, i.jsx)("p", {
                                  children:
                                    'We have reached out to Kabosumama a 2nd time for further clarification to put any doubt to end about Muku’s legitimacy. Stay Tuned!',
                                }),
                                (0, i.jsx)("p", {
                                  className: "font-bold",
                                  style: { color: "#FD8A1B" },
                                  children:
                                    "Video proof that Muku is kabosumama’s adopted kitten!",
                                }),
                              ],
                            }),
                          ],
                      ...
                      (0, i.jsx)(d.P.div, {
                        ...
                        children: (0, i.jsx)("video", {
                          src: "/nextImageExportOptimizer/new.mp4",
                          autoPlay: !0,
                          muted: !0,
                          loop: !0,
                          playsInline: !0,
      ...
      let v = () => {
          ...
          return (0, i.jsxs)("section", {
            className: "relative py-24 overflow-visible z-10",
            id: "tokenomics",
            children: [
              (0, i.jsxs)("div", {
                className: "absolute inset-0 z-0",
                  ...
                  (0, i.jsxs)(h.A, {
                    ...
                    children: [
                      ...
                      (0, i.jsx)(d.P.p, {
                        ...
                        transition: { delay: 0.4, duration: 0.6 },
                        children:
                          "A Muku-powered economy designed for fairness and transparency",
                      }),
                    ],
                  }),
                  (0, i.jsx)("div", {
                      ...
                      children: e.map((e, t) =>
                        (0, i.jsx)(
                          h.A,
                          {
                            children: (0, i.jsxs)(d.P.div, {
                              className:
                                "bg-white rounded-xl p-6 relative overflow-visible group",
                              initial: { opacity: 0, y: 20 },
                              animate: { opacity: 1, y: 0 },
        ...
        w = () => {
          let e = [
            ...
            },
            {
              title: "Visit Uniswap",
              description:
                "Connect your wallet to Uniswap.org. Paste the $MUKU token contract address.",
              icon: (0, i.jsx)(r.yk7, { size: 32 }),
              color: "#FF8C00",
            },
            {
              title: "Swap ETH for $MUKU",
              description:
                "Enter the amount of $MUKU you want to buy, adjust slippage tolerance, and swap your ETH for $MUKU.",
                  ...
                  (0, i.jsxs)(h.A, {
                    ...
                    children: [
                      ...
                      (0, i.jsx)(d.P.p, {
                        ...
                        transition: { delay: 0.4, duration: 0.6 },
                        children:
                          "Ready to join MUKU's family? Follow these simple steps to get your hands on some adorable $MUKU tokens!",
                      }),
                    ],
                  }),
                  (0, i.jsx)("div", {
                  ...
                  (0, i.jsxs)(h.A, {
                    ...
                    children: [
                      ...
                      (0, i.jsx)(d.P.p, {
                        ...
                        transition: { delay: 0.4, duration: 0.6 },
                        children:
                          "The journey of MUKU from shelter pup to memecoin sensation!",
                      }),
                    ],
                  }),
                  (0, i.jsxs)("div", {
                  ...
                  children: [
                    (0, i.jsxs)(d.P.div, {
                      ...
                      children: [
                        (0, i.jsx)(d.P.div, {
                          className:
                            "w-16 h-16 relative overflow-visible rounded-full",
                ...
                children: [
                  ...
                  (0, i.jsx)(w, {
                    howToBuySteps: [
                      ...
                      {
                        step: 4,
                        title: "Swap SOL for $MUKU",
                        description: "Enter the $MUKU token address and swap.",
                      },
                    ],
                  }),
                  (0, i.jsx)(j, {
